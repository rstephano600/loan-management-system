<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <select id="group_center_id" name="group_center_id" class="form-select @error('group_center_id') is-invalid @enderror">
    ...
    <div class="col-md-4">
        ...
        <select id="client_type" name="client_type" class="form-select @error('client_type') is-invalid @enderror" required>
            ...
            {{-- Note: Added 'llc' to corporation group --}}
    ...
    <hr class="mt-4 mb-3">
    <h5 class="col-12">Business Details (If Applicable)</h5>
    ...
    <hr class="mt-4 mb-3">
    <h5 class="col-12">Address Details</h5>
    ...
    <hr class="mt-4 mb-3">
    <h5 class="col-12">Personal KYC Details</h5>
    <div class="col-md-4">
    ...
    <hr class="mt-4 mb-3">
    <h5 class="col-12">Credit and Risk Details</h5>
    ...
    <hr class="mt-4 mb-3">
    <h5 class="col-12">Administrative & KYC</h5>

    <div class="col-md-6">
        <label for="assigned_loan_officer_id" class="form-label">Assigned Loan Officer</label>
        {{-- NOTE: You'll need to dynamically populate this SELECT with users/officers --}}
        <select id="assigned_loan_officer_id" name="assigned_loan_officer_id" class="form-select @error('assigned_loan_officer_id') is-invalid @enderror">
            <option value="">-- Select Officer --</option>
            {{-- Example of how to loop through users passed from the controller: --}}
            {{-- @foreach($users as $user)
                <option value="{{ $user->id }}" {{ old('assigned_loan_officer_id', $client->assigned_loan_officer_id ?? '') == $user->id ? 'selected' : '' }}>
                    {{ $user->name }}
                </option>
            @endforeach --}}
            {{-- Placeholder for demonstration: --}}
            <option value="1" {{ old('assigned_loan_officer_id', $client->assigned_loan_officer_id ?? '') == 1 ? 'selected' : '' }}>John Doe (ID: 1)</option>
        </select>
        @error('assigned_loan_officer_id') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    ...
    {{-- The kyc_completed_at field is handled in the controller, no need for form field --}}
