...
@section('title', 'Refunded Loans Informations')

@section('page-title', 'Refunded Loans Informations')
            ...
            <table class="arbif-table"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('unrefundloansinfo', encrypt($item->id)) }}"
