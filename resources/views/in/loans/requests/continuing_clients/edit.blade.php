...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('loan_request_continueng_client.update', $loan->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-12 text-end">
                        ...
                        <a href="{{ route('loan_request_continueng_client.index') }}" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
